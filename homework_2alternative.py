...
while player == False:
    ...
    if player == computer:
        ...
        if computer == "paper":
            print("You lose!","Computer played:",computer,"You played:",player)  # wie setzte ich einen Zeilenumbruch ein
        else:
        ...
        if computer=="rock":
            ...
            print("You lose!","Computer played:",computer,"You played:",player)
